...
## Build decisions
- Manage Users' role dropdown reverted to Administrator/Reviewer/User (builder clarified those labels were correct as they were) and the table columns swapped to Role first, Email second (builder's request).
